    ...
    private function show_core_notice() {
        ...
        */
        ...
        <div class="ht_contactform_diagnostic_data_notice">
            <h4 class="ht_contactform_diagnostic_data_title">
                <?php
                    /* translators: %1$s: project name */
                    echo sprintf( esc_html__('🌟 Enhance Your %1$s Experience as a Valued Contributor!','ht-contactform'), esc_html( $this->project_name ));
                ?>
            </h4>
            <p class="ht_contactform_diagnostic_data_message"><?php echo wp_kses_post( $message_l1 ); ?></p>
