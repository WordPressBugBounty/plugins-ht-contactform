...
* Fixed: The "Minimum time to submit" spam protection setting never rejected fast submissions on AJAX-enabled forms.
...
* Fixed: Date & time picker not displaying or positioning correctly on the frontend.

= Version: 2.8.3 - Date: 03-May-2026 =
* Security: Improved sanitization of richtext and file upload fields.

= Version: 2.8.2 - Date: 25-Feb-2026 =
